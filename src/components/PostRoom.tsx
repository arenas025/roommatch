...
const PostRoom = () => {
  const handleSubmit = () => {
    ...
    if ((name && email && phone) === null) {
      ...
      alert(
        "Información enviada. En los proximos dias se te enviara un correo para que subas las fotos de tu vivienda"
      );
    }
  };
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-screen p-4 lg:w-2/4 mt-10">
        <div className="flex flex-col">
          ...
          <form id="form">
            <div>
              ...
              <div className="flex gap-5 w-full justify-center flex-col pt-5 pb-5">
                <div className="flex items-center">
                  ...
                  <input
                    name="name"
                    className="border-2 ml-5 p-2 rounded-lg border-slate-200 w-[300px] lg:w-2/4"
                    type="text"
                  />
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  <label className="text-xl">Número de celular</label>
                  <input
                    name="phone"
                    className="border-2 ml-5 p-2 rounded-lg border-slate-200 w-[300px] lg:w-2/4"
                    type="number"
            ...
            <div className="flex flex-col gap-5 pb-5 pt-5">
              <div className="flex items-center">
                <label className="text-xl">Habitaciones</label>
              ...
              <div className="flex items-center">
                <label className="text-xl">Baños</label>
              ...
              <div className="flex items-center">
                <label className="text-xl">¿Para cuantas personas?</label>
              ...
              <div className="flex items-center">
                <label className="text-xl">Precio de alquiler</label>
                <input className={`${iStyle} ml-10 lg:ml-24`} type="number" />
              </div>
              <div className="flex items-center">
                <label className="text-xl">¿Amoblado?</label>
              ...
              <div className="flex flex-col">
                <label className="text-xl">Descripción de tu piso</label>
